...
c	Modified to exclude path's of rays that dive deeper below the 
c       interface
...
c          dtdz = cosn * ( cos1/vel1 - cos2/vel2 )
           dtdz = sqrt(vel2*vel2-vel1*vel1)/(vel2*vel1)
...
c          dtdz = cosn * ( cos1/vel1 - cos2/vel2 )
 ...
 660       write (31,1030) line,spn,xbas,ybas,zbas,tt,dtdz
           write (*,*) line,spn,xbas,ybas,zbas,tt,vel1,vel2,dtdz
         else
           read (24,1060) line,spn,xbas,ybas,zbas,tt,cos1,cos2,cosn
         endif
C
...
c     Check if number of hw traces O.K.
      if (qqqq.ne.nbshot) then
        write (*,*) 'qqqq.ne.nbshot at crosspoint file'
	stop
      endif
c
      close (22)
...
c
      open (40,file='last_shot_hw.n',status='unknown')
      write (40,*) nshot_start+nbshot
      close (40)
c
 1010 format (a80)
