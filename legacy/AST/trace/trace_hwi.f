...
c
      ...
      parameter    (nxyzmx=4000000,nsmax=50000,nxymax=40000)
     ...
     *             pwflag,r1flag,qq,qqq,nshot_start,n1,n2,
...
c      
      ...
      read (*,*) crossfile
      write (*,*) 'input velocity model file name'
      read (*,*) vfile
...
c     WRITE OUT THE COVERAGE
     ...
     *     recl=4*(nx-1),status='unknown')
      do 520, k=1,nz-1
         ...
         do 510, j=1,ny-1
            nkj = nk+(nx-1)*(j-1)
            write (22,rec=nk2+j) (nrays(nkj+i),i=1,nx-1)
            write (23,rec=nk2+j) (du(nkj+i),i=1,nx-1)
 510     continue
 520  continue
      close (22)
      close (23)
...
c
      ...
      if (iy2d.eq.1) ny=1
c
c     READ VELOCITY MODEL FILE
      open (21,file=vfile,form='unformatted',access='direct',
     *     recl=4*nx,status='old')
      do 610, k=1,nz
         nk = nx*ny*(k-1)
         nk2 = (k-1)*ny
...
c        BELOW - TO CALCULATE VEL2
	 ...
	 write (31,*) nshot
 650     write (31,1030) line,spn,xbas,ybas,zbas,tt,dtdz
