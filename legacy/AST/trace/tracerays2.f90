...
c
      ...
      parameter    (nxyzmx=4000000,nsmax=50000,nxymax=500000)
...
c        CALCULATE DT/DZ AND WRITE
     ...
     *        v1(iiiii+nx*ny+nx+1))/8.
         vel2 = (t(iiiii)+t(iiiii+1)+t(iiiii+nx)+t(iiiii+nx*ny)+
     *        t(iiiii+nx+1)+t(iiiii+nx*ny+1)+t(iiiii+nx*ny+nx)+
     *        t(iiiii+nx*ny+nx+1))/8.
