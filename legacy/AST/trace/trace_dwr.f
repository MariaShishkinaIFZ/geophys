      program trace_hwr
c
c       Modified to provide ray traces for direct waves only
...
c
     ...
     *             pwflag,r1flag,qq,qqq,qqqq,nshot_start,
...
c      
      ...
      read (*,*) tracefile
c     write (*,*) 'input the filename for the basement crossing points'
c     read (*,*) crossfile
...
c      open (31,file=crossfile,status='unknown')
c
c
c
...
c     Check if number of hw traces O.K.
      if (qqqq.ne.ngshot-nbshot) then
        write (*,*) 'qqqq.ne.ngshot-nbshot'
	stop
      endif
c     ---------------------------------
c     Uncomment the following line to write out the last trace number
c     at the end of the file  
c     write (21,*) nshot_start+(ngshot-nbshot)
      close (21)
      close (30)
c
...
c
      ...
      write (*,*) ngshot-nbshot, ' direct wave traces'
c
 1010 format (a80)
