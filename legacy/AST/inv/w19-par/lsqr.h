...
*                         rel_rhs_err = 1.0e-6 .
*
*     abs_resid    input  An estimate of the data rms error. Iterations
*                         will stop then the norm of the residuals ||Ax - b||
*                         is equal or less then abs_resid.
*                         If negative, this criteria will not be used for
*                         the process control.
*
...
*                             I.e. relative values of errors are considered.
*
...
*  
*                     8       The norm of the residuals vector ||Ax - b|| is
*                             less then 'abs_resid'. I.e. the solution with the
*                             required absolute accuracy is found.
* 
