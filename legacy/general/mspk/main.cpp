...
int main(int argc, char* argv[])
{
   ...
   if (argc<3)
   {
     fprintf(stderr,"mspk <6-cols data file [.tpk]> <8-cols computed peaks file from getpeaks [.dat]>\n");
     sprintf(s,"Selects computed time corresponding fod data peaks\n");
     GSTerror(s);
   }
