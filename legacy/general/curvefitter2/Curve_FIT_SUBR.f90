...
!             WRITE (*,*) k
            ...
            call Curve_Fitting(file, k, n_exp,RMS)
            
          END PROGRAM

    !---------------------
    subroutine Curve_Fitting(file, k, n_exp,RMS)
    implicit none
    character(254) file
    integer k
    real(8) RMS, P(0:k) !output
...
!         write(*,*)sumi(i)
    ...
    !write(*,*)'matrix A'
    !write(*,'(1x,3(1x,f12.6))')((A(i9,j9),i9 = 0,k), j9 = 0,k)
        
    call MATR_INVERT(AA, AA_inv, k+1, ind_err)
    !write(*,*)'ind_err = ',ind_err
    
    !write(*,*)'matrix A_inv'
    !write(*,'(1x,3(1x,f12.6))')((AA_inv(i9,j9),i9 = 1,k+1), j9 = 1,k+1)
    ...
    !write(*,*)'Prov'
    !write(*,'(1x,3(1x,f12.6))')((prov(i9,j9),i9 = 0,k), j9 = 0,k)
