...
zs=0;
  ...
  while (!feof(fi))
  {
   ...
   if (((c%3)==0) && ((yp<left_boarder) || (right_boarder<yp)) && ((left_cut<yp) && (yp<right_cut))) fprintf(fo_hw,"1   %5i %10g %10g %10g\n",i,d,az,tp);

   if (((c%3)==0) && ((left_boarder<yp) && (yp<right_boarder)) && ((left_cut<yp) && (yp<right_cut))) fprintf(fo_dw,"1   %5i %10g %10g %10g\n",i,d,az,tp);
